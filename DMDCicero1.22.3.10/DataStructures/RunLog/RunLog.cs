...
namespace DataStructures
{
    ...
    public class RunLog
    {
        ...
        public string WriteLogFile()
        {
            ...
            // Code modified by Jere starts here (previous line commented by Jere as well)
            // Get the current date.
            //DateTime thisDay = DateTime.Today;
            //string dateString = thisDay.ToString("yyyy-MM-dd");
            //string fileDirectory = @"\\storage.yale.edu\home\navon-627019-FASPHY\Li Lab\DMDCicero Runlogs\" + dateString.Replace("-", @"\") + @"\";
